checkSuggestionObjectionSubmit = function () {
    var checks = true;
    var errorFields = [];
    if ($("#inputObjectionText").val().length == 0)
    {
        checks = false;
        errorFields.push('شرح اعتراض');
        $("#inputObjectionText").addClass('empty');
    }
    else
    {
        $("#inputObjectionText").removeClass('empty');
    }
...
checkSuggestionObjectionResponseSubmit = function () {
    var checks = true;
    var errorFields = [];
