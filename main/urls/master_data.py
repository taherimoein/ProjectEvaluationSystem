...
urlpatterns = [
    ...
    path('ajax/personnel/deactive/', personnelviews.deactive_personal, name = 'ajax_deactive_personal'),
    path('ajax/personnel/active/', personnelviews.active_personal, name = 'ajax_active_personal'),
