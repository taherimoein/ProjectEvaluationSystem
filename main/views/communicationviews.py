...
#         'Users': users
#     }
    return render(request, 'main/communication/communication-list.html', )
...
@is_governor
@login_required(login_url = 'main:sign_page')
def communication_detail_page(request):
    return render(request, 'main/communication/communication-detail.html', )
